        ...
        <section >
            <div className="row align-items-center container ">
                <div className="col-lg-5">
                    <div className="py-5 px-4 px-sm-5 m-lg-3" style={{ backgroundColor: "gray" }}>
                        <Container
                            component="main"
                            maxWidth="xs"
                            sx={{
                ...
                <div className="col-lg-7">
                    <div className="row mt-5 container d-flex justify-content-center align-items-center m-auto">
                        {records.map((curUser) => {
                            return (
                                <div style={{ width: '300px' }} className="col-12 col-sm-6 col-md-4 col-lg-3 py-2" key={curUser.id}>
                                    <div className="card border-gray border-3">
                                        <img
                                            src={image[records.indexOf(curUser)]}
                                        ...
                                        <div className="card-body">
                                            <h5 className="card-title">Name : {curUser.username}</h5>
                                            <p className="card-text">Email : {curUser.email}</p>
                                            <p className="card-text">Password : {curUser.password}</p>
                                            <div className="d-flex justify-content-around align-items-center">
                                                <button
                                                    className="btn btn-primary"
                                                    onClick={() => handleEdit(curUser.id)}
                                                >
                                                    Edit
                                                </button>
                                                <button
                                                    className="btn btn-danger"
                                                    onClick={() => handleDelete(curUser.id)}
                                                >
                                                    Delete
                                                </button>
                                            </div>
